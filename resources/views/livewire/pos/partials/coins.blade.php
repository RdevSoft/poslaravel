<div class="row mt-3">
    <div class="col-sm-12">
        <div class="connect-sorting"> {{-- esto crea un recuadro de fondo --}}
            ...
            <div class="card simple-title-task">
                <div class="input-group input-group-md mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text input-hp hideonsm" style="background: #3b3f5c; color:white">
                        Efectivo f8
                        </span>
                    </div>
                    ...
                    <div class="input-group-append">
                        <span wire:cick="$set('efectivo',0)" class="input-group-text" style="background: #3b3f5c; color:white">
                ...
                <div class="row justify-content-between mt-5">
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        @if($total > 0)
                        <button onclick="Confirm('','clearCart','SEGURO QUE QUIERE ELIMINAR EL CARRITO?')" class="btn
                        btn-dark mtmobile">
                            CANCELAR F4
                        </button>
                            @endif
