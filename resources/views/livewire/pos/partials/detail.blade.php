<div class="connect-sorting">
    ...
    <div class="connect-sorting-content">
        <div class="card simple-tittle-task ui-sortable-handle">
            <div class="card-body">
                @if($total>0)
            <div class="table-responsive tblscroll" style="max-height: 650px; overflow: hidden">
                <table class="table table-bordered table-striped mt-1">
                    ...
                    <th class="table-th text-center tcenterext-white">Precio</th>
                    ...
                    <tr>
                        <td class="text-center table-th">
                            ...
                            <span>
                                <img src="{{ asset('storage/products/' .$item->attributes[0]) }}" alt="imagen de
                                producto" height="90" width="90" class="rounded">
                            </span>
                        @endif
                            <!---->
                        </td>
